...
enum AdjustKey: String {
    case AdjustKeyAppToken = "7geuyd8avjls"
    case AdjustKeyAppLaunch = "rxbiut"
    case AdjustKeyAppCoinsBuy = "cl8c7a"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initMainVC() {
        let mainVC: SLHymMainVC = SLHymMainVC()
    ...
    func initCore() {
        ...
        //com.Likestagmore.Supercaptions
        
//        NotificationCenter.default.post(name: .Pre,
//                                        object: [
//                                            HightLigtingHelper.default.debugBundleIdentifier = "com.Likestagmore.Supercaptions",
